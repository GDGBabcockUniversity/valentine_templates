...
import { ArrowLeft, Share2, X, Loader2 } from "lucide-react";
          ...
          <div className="animate-in fade-in slide-in-from-left-4 duration-300">
            ...
            <div className="mt-8 mb-12">
               <button 
                ...
                className="w-full bg-white hover:bg-gray-100 disabled:bg-gray-400 text-black font-bold py-4 rounded-full flex items-center justify-center gap-2 transition-all shadow-lg shadow-white/10"
              >
                {isPublishing ? (
